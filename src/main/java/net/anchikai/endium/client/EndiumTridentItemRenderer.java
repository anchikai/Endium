package net.anchikai.endium.client;
...
public class EndiumTridentItemRenderer implements BuiltinItemRendererRegistry.DynamicItemRenderer, SimpleSynchronousResourceReloadListener {
    private final Identifier id;
    private final Identifier tridentId;
    private final Identifier texture;
    private final EntityModelLayer modelLayer;
    private ItemRenderer itemRenderer;
    private EndiumTridentEntityModel tridentModel;
    private BakedModel inventoryTridentModel;

    public EndiumTridentItemRenderer(Identifier tridentId, Identifier texture, EntityModelLayer modelLayer) {
    ...
    public void reload(ResourceManager manager) {
        ...
        this.tridentModel = new EndiumTridentEntityModel(mc.getEntityModelLoader().getModelPart(this.modelLayer));
