package net.anchikai.endium.client.render.entity.model;
...
public class EndiumTridentEntityModel extends Model {
    private final ModelPart root;

    public EndiumTridentEntityModel(ModelPart root) {
