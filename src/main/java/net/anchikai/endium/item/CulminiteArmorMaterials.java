...
public class CulminiteArmorMaterials implements ArmorMaterial {

    public static final CulminiteArmorMaterials CULMINITE = new CulminiteArmorMaterials();

    private static final int[] BASE_DURABILITY = new int[]{13, 15, 16, 11};
    private final SoundEvent equipSound = SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE;
    private final int durabilityMultiplier = 37;
    ...
    public Ingredient getRepairIngredient() {
        return Ingredient.ofItems(CulminiteItems.CULMINITE_INGOT);
    }
