...
public class ModItems {
    ...
    public static final Item AMARANTH_BOAT = registerItem("amaranth_boat",
            new ModBoatItem(false, BoatEntity.Type.OAK, (new FabricItemSettings()).maxCount(1).group(ModItemGroup.ENDIUM)));
    public static final Item AMARANTH_CHEST_BOAT = registerItem("amaranth_chest_boat",
            new ModBoatItem(true, BoatEntity.Type.OAK, (new FabricItemSettings()).maxCount(1).group(ModItemGroup.ENDIUM)));
    // Endium Items
